/*
 * This file is a part of project QuickShop, the name is MojangAPI.java Copyright (C) Ghost_chu
...
public class MojangAPI {
  ...
  @Nullable
  public String downloadTextFileFromMojang(@NotNull File container, @NotNull String hash) throws IOException {
    File cacheFile = new File(container, hash);
    if (cacheFile.exists()) {
      return Utils.readToString(cacheFile);
    }
    String data;
